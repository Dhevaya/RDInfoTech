  ...
  return (
    <div className="w-full font-sans" style={{ fontFamily: 'Inter, sans-serif' }}>
      ...
      <form onSubmit={handleStudentVerification} className="mb-8">
          <h2 className="text-xl font-semibold text-[#280E5C] mb-2" style={{ fontFamily: 'Inter, sans-serif' }}>Student Certificate Verification</h2>
          <label htmlFor="studentId" className="block mb-1 font-medium" style={{ fontFamily: 'Inter, sans-serif' }}>
      ...
      <form onSubmit={handleAtcVerification}>
          <h2 className="text-xl font-semibold text-[#280E5C] mb-2" style={{ fontFamily: 'Inter, sans-serif' }}>ATC (Franchise Partner) Verification</h2>
          <label htmlFor="atcCode" className="block mb-1 font-medium" style={{ fontFamily: 'Inter, sans-serif' }}>
          Enter ATC Code
        </label>
        <input
          type="text"
