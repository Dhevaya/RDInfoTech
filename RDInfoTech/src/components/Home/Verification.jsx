...
// import React, { useState } from 'react';
// import verImg from '../../assets/ver.png'; // Import the ver.png image
...
//   return (
//     <div className="w-full font-sans" style={{ fontFamily: 'Inter, sans-serif' }}>
//       <div className="w-full max-w-[1440px] h-[338px] mx-auto flex items-center justify-center">
//         <img 
//           src={verImg} 
//           alt="Verification Banner" 
//           className="w-full h-full object-cover" 
//           onError={(e) => (e.target.src = 'https://via.placeholder.com/1440x338?text=Verification+Banner')} 
//         />
//       </div>
//       <div className="max-w-7xl mx-auto px-4 py-8 w-full">
//         <h1 className="text-3xl font-bold text-[#280E5C] mb-6 text-center" style={{ fontFamily: 'Inter' }}>
