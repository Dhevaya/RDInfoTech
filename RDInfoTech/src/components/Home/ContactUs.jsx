...
// // //           <button
// // //             type="submit"
// // //             className="bg-[#280E5C] text-white px-6 py-2 rounded hover:bg-[#2a2050] transition-colors w-auto mx-auto block text-base min-w-[100px] disabled:opacity-60 disabled:cursor-not-allowed"
...
// // import React, { useState } from 'react';
// // import { FaUser, FaPhone, FaAlignJustify } from 'react-icons/fa';
// // import contactImg from '../../assets/contact.png'; // Import the contact.png image

// // const ContactUs = () => {
// //   const [formData, setFormData] = useState({
// //     name: '',
// //     contactNumber: '',
// //     requirement: '', // Set to empty string to avoid preselection
// //     description: '',
// //   });
...
// //         name: '',
// //         contactNumber: '',
// //         requirement: '', // Reset to empty string
// //         description: '',
// //       });
// //     } catch (error) {
// //       setMessage('Failed to send your message.');
...
// //     <div className="w-full min-h-screen flex flex-col items-center justify-center pt-0 mt-0 bg-[#f7f7fb]">
// //       {/* Full-width Image */}
// //       <div className="w-screen flex items-center justify-center mt-0 pt-0" style={{ height: '338px' }}>
// //         <img 
// //           src={contactImg} 
// //           alt="Contact Us Banner" 
// //           className="w-full h-full object-cover" 
// //           onError={(e) => (e.target.src = 'https://via.placeholder.com/1440x338?text=Contact+Us+Banner')} 
// //         />
// //       </div>
// //       {/* Heading and Form */}
// //       <div className="w-full max-w-xl flex flex-col items-center justify-center mt-8">
...
//   return (
//     <div className="w-full min-h-screen flex flex-col items-center justify-start pt-0 mt-0 bg-[#f7f7fb]">
//       {/* Full-width Image */}
//       <div className="w-screen flex items-center justify-center mt-0 pt-0" style={{ height: '338px' }}>
//         <img 
//           src={contactImg} 
...
const ContactUs = () => {
  ...
  return (
    <>
      ...
      <div className="w-full min-h-screen flex flex-col items-center justify-start pt-0 mt-0 bg-[#f7f7fb] overflow-x-hidden">
        {/* Full-width Image */}
        <div className="w-screen flex items-center justify-center mt-0 pt-0" style={{ height: '338px' }}>
          <img 
            src={contactImg} 
